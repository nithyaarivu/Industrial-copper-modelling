...
with tab1:
    ...
    if submit_button and flag == 0:
        ...
        with open("C:/Users/smm/model.pkl", 'rb') as file:
            loaded_model = pickle.load(file)
        with open('C:/Users/smm/scaler.pkl', 'rb') as f:
            scaler_loaded = pickle.load(f)

        with open("C:/Users/smm/t.pkl", 'rb') as f:
            t_loaded = pickle.load(f)

        with open("C:/Users/smm/s.pkl", 'rb') as f:
...
with tab2:
    ...
    if csubmit_button and cflag == 0:
        ...
        with open("C:/Users/smm/classifiermodel2.pkl", 'rb') as file:
            cloaded_model = pickle.load(file)

        with open('C:/Users/smm/classifierscaler2.pkl', 'rb') as f:
            cscaler_loaded = pickle.load(f)

        with open("C:/Users/smm/classifierencode2.pkl", 'rb') as f:
